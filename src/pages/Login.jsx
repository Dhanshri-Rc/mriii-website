...
function Login() {
  ...
  whileTap={{ scale: 0.98 }}
  className="w-full h-[46px] rounded-[7px] bg-gradient-to-r from-[#C9960C] to-[#B8860B] text-white text-[14px] font-semibold mb-3 flex items-center justify-center gap-2 shadow-md"
>
  LOGIN
  <ArrowRight size={18} />
</motion.button>
